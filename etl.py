...
# Function which provides data from song file
...
# Function which provides data from log file
...
# Function which processes data from all files
...
def main():
    ...
    # Cursor is created which is further used for query
    cur = conn.cursor()
